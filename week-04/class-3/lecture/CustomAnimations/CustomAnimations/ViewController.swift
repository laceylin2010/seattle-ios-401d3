...
class ViewController: UIViewController
{
    ...
    func animateFrame()
    {
        ...
        UIView.animateWithDuration(0.4, delay: 0.0, usingSpringWithDamping: 0.8, initialSpringVelocity: 0.1, options: UIViewAnimationOptions.CurveEaseIn, animations: { () -> Void in
